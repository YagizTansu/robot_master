...
ScanMatcherConfig ScanMatcherConfig::fromNode(rclcpp::Node & node)
{
  ...
  node.declare_parameter("noise.lidar.icp_fitness_score_threshold", cfg.icp_fitness_score_threshold);
  node.declare_parameter("noise.lidar.fitness_noise_scale",         cfg.fitness_noise_scale);
  node.declare_parameter("noise.lidar.map_voxel_leaf_size",         cfg.map_voxel_leaf_size);
  ...
  cfg.icp_fitness_score_threshold = node.get_parameter("noise.lidar.icp_fitness_score_threshold").as_double();
  cfg.fitness_noise_scale       = node.get_parameter("noise.lidar.fitness_noise_scale").as_double();
  cfg.map_voxel_leaf_size       = node.get_parameter("noise.lidar.map_voxel_leaf_size").as_double();
